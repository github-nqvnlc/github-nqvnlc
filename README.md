...
🎯 **Passionate Fullstack Developer** from Da Nang, Vietnam  
🎨 **Digital Artist** with a passion for UI/UX design  
🏫 **Bachelor of Information Technology** - University of Greenwich Vietnam  
🚀 **Freelancer** always ready for new challenges  
...
⭐ **Features:** Smart booking, User authentication, Real-time availability
...
⭐ **Features:** Real-time scoring, Multiple categories, Offline mode
...
⭐ **Features:** Responsive design, Interactive UI, Professional layout
...
⭐ **Features:** Post management, User authentication, Comment system
...
⭐ **Features:** Animations, Interactive elements, Space theme
...
⭐ **Features:** Modern design, Responsive layout, Portfolio showcase

</td>
</tr>
</table>

### 📚 **2022 - Foundation Projects**
...
⭐ **Features:** Expense tracking, Reports, Multi-currency
...
⭐ **Features:** Cross-platform, Cloud sync, Intuitive UI
...
⭐ **Features:** Course creation, Registration system, Progress tracking
...
⭐ **Features:** News publishing, Mini games, Activity posts
...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=400&size=20&pause=1000&color=00BFFF&center=true&vCenter=true&width=600&lines=Thanks+for+visiting+my+profile!;Happy+coding!+%F0%9F%9A%80;Let's+build+something+amazing+together!)](https://git.io/typing-svg)
